...
const HINT_MARKS: Mark[] = [
  { at: 100 * HINT_STARTS_AT, color: "var(--hint-starts)", label: "רמז: כמה מילים מתחילות בכל אות" },
  { at: 100 * HINT_USES_AT, color: "var(--hint-uses)", label: "רמז: בכמה מילים כל אות נמצאת" },
];
