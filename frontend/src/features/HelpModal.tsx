      ...
      <SheetBody className="helpbody">
        ...
        <section className="helpsec" style={at(2)}>
          ...
          <ul>
            ...
            <li><b>מספרים על האותיות</b> - ככל שמתקדמים נפתחים רמזים, והסימנים על פס ההתקדמות מראים מתי: כשמגיעים ל-45% יופיע <b className="hintstarts">מספר כחול</b> למעלה - כמה מילים מרכזיות שנותרו מתחילות באות, ובהגעה ל-75% <b className="hintuses">מספר ירוק</b> למטה - בכמה מהן האות נמצאת</li>
          </ul>
        </section>
