      ...
      <SheetBody className="helpbody">
        ...
        <section className="helpsec" style={at(3)}>
          ...
          <ul>
            ...
            <li><b className="bonusword">מילות בונוס</b> - מילים עם צורות מיוחדות יותר - סמיכות, הטיה (ילדיו, ארונה), ומילות סלנג. הן מופיעות כ-+ ליד מספר המילים, ולא צריך אותן כדי לסיים את הלוח היומי</li>
