      ...
      <SheetBody className="helpbody">
        ...
        <section className="helpsec" style={at(2)}>
          ...
          <ul>
            ...
            <li><b>מספרים על האותיות</b> - ככל שמתקדמים נפתחים רמזים, והסימנים על פס ההתקדמות מראים מתי: קודם יופיע <b className="hintstarts">מספר כחול</b> למעלה - כמה מילים מרכזיות שמתחילות באות נותרו, ואחר כך <b className="hintuses">מספר ירוק</b> למטה - כמה מילים מרכזיות שעוברות באות נותרו</li>
          </ul>
        </section>
