      ...
      <SheetBody className="helpbody">
        ...
        <section className="helpsec" style={at(3)}>
          ...
          <ul>
            ...
            <li><b className="bonusword">מילות בונוס</b> הן מילים עם צורות מיוחדות יותר — סמיכות, הטיה (ילדיו, ארונה) ומילות סלנג. הן שוות כפול נקודות, אבל לא צריך אותן כדי לסיים את הלוח היומי.</li>
            <li><b>★ מילות נושא</b> — מופיעות בימים עם משמעות מיוחדת, כמו חגים או מועדים נוספים.</li>
          </ul>
        </section>
