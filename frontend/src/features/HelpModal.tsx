        ...
        <section className="helpsec" style={at(2)}>
          ...
          <ul>
            ...
            <li><b>רמזים נפתחים בדרך</b> - הסימנים על פס ההתקדמות מראים מתי, וכל רמז מוסבר ברגע שהוא נפתח:
              <b className="hintsort">מיון רשימת המילים לפי א-ב</b>, <b className="hintreveal">חשיפת אותיות מהמילים שנותרו</b>,
              ו<b className="hintstarts">מספר אדום</b> על כל אות - כמה מילים מרכזיות שמתחילות בה נותרו</li>
          </ul>
        </section>
