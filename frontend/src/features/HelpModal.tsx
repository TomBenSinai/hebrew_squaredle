      ...
      <SheetBody className="helpbody">
        ...
        <section className="helpsec" style={at(2)}>
          ...
          <ul>
            ...
            <li><b>מספרים על האותיות</b> - ככל שמתקדמים נפתחים רמזים: ברבע הדרך יופיע בפינה העליונה של כל אות כמה מילים מרכזיות שנותרו מתחילות בה, ובחצי הדרך יופיע בפינה התחתונה בכמה מילים היא נמצאת</li>
          </ul>
        </section>
